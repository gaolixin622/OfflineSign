...
/**
 * A {@code ApiWrapperWithoutPrivateKey} object is the entry point for calling the functions.
 *
 *<p>A {@code ApiWrapperWithoutPrivateKey} object is bind with a private key and a full node.
 * {@link #broadcastTransaction}, {@link #signTransaction} and other transaction related
 * operations can be done via a {@code ApiWrapperWithoutPrivateKey} object.</p>
 *
...
public class ApiWrapperWithoutPrivateKey {
    ...
    public ApiWrapperWithoutPrivateKey(String grpcEndpoint, String grpcEndpointSolidity) {
    ...
    public ApiWrapperWithoutPrivateKey(String grpcEndpoint, String grpcEndpointSolidity, String apiKey) {
        channel = ManagedChannelBuilder.forTarget(grpcEndpoint).usePlaintext().build();
        channelSolidity = ManagedChannelBuilder.forTarget(grpcEndpointSolidity).usePlaintext().build();
     ...
     * @return a ApiWrapperWithoutPrivateKey object
     */
    public static ApiWrapperWithoutPrivateKey ofMainnet(String apiKey) {
        return new ApiWrapperWithoutPrivateKey(Constant.TRONGRID_MAIN_NET, Constant.TRONGRID_MAIN_NET_SOLIDITY, apiKey);
    }
     ...
     */
    @Deprecated
    public static ApiWrapperWithoutPrivateKey ofMainnet() {
        return new ApiWrapperWithoutPrivateKey(Constant.TRONGRID_MAIN_NET, Constant.TRONGRID_MAIN_NET_SOLIDITY);
    }
     ...
     * @return a ApiWrapperWithoutPrivateKey object
     */
    public static ApiWrapperWithoutPrivateKey ofShasta() {
        return new ApiWrapperWithoutPrivateKey(Constant.TRONGRID_SHASTA, Constant.TRONGRID_SHASTA_SOLIDITY);
    }
     ...
     * @return a ApiWrapperWithoutPrivateKey object
     */
    public static ApiWrapperWithoutPrivateKey ofNile() {
        return new ApiWrapperWithoutPrivateKey(Constant.FULLNODE_NILE, Constant.FULLNODE_NILE_SOLIDITY);
    }
    ...
    public long getAvailableUnfreezeCount(String ownerAddress) {
        ByteString rawOwner = parseAddress(ownerAddress);
        GetAvailableUnfreezeCountRequestMessage getAvailableUnfreezeCountRequestMessage =
            GetAvailableUnfreezeCountRequestMessage.newBuilder()
                .setOwnerAddress(rawOwner)
                .build();
        GetAvailableUnfreezeCountResponseMessage responseMessage = blockingStub.getAvailableUnfreezeCount(getAvailableUnfreezeCountRequestMessage);
    ...
    public long getCanWithdrawUnfreezeAmount(String ownerAddress)  {
        ByteString rawOwner = parseAddress(ownerAddress);
        CanWithdrawUnfreezeAmountRequestMessage getAvailableUnfreezeCountRequestMessage =
            CanWithdrawUnfreezeAmountRequestMessage.newBuilder()
                .setOwnerAddress(rawOwner)
                .build();
        CanWithdrawUnfreezeAmountResponseMessage responseMessage = blockingStub.getCanWithdrawUnfreezeAmount(getAvailableUnfreezeCountRequestMessage);
    ...
    public long getCanDelegatedMaxSize(String ownerAddress,int type)  {
        ByteString rawFrom = parseAddress(ownerAddress);
        CanDelegatedMaxSizeRequestMessage getAvailableUnfreezeCountRequestMessage =
            CanDelegatedMaxSizeRequestMessage.newBuilder()
                .setOwnerAddress(rawFrom)
                .setType(type)
                .build();
        CanDelegatedMaxSizeResponseMessage responseMessage = blockingStub.getCanDelegatedMaxSize(getAvailableUnfreezeCountRequestMessage);
    ...
    /*public void transferTrc20(String from, String to, String cntr, long feeLimit, long amount, int precision) {
        ...
        TriggerSmartContract trigger =
            TriggerSmartContract.newBuilder()
                .setOwnerAddress(ApiWrapperWithoutPrivateKey.parseAddress(from))
                .setContractAddress(ApiWrapperWithoutPrivateKey.parseAddress(cntr)) // JST
                .setData(ApiWrapperWithoutPrivateKey.parseHex(encodedHex))
                .build();

        System.out.println("trigger:\n" + trigger);

        TransactionExtention txnExt = blockingStub.triggerContract(trigger);
        System.out.println("txn id => " + ApiWrapperWithoutPrivateKey.toHex(txnExt.getTxid().toByteArray()));
